...
exports.homepage = catchAsyncError((req, res, next) => {
	res.send(` <div style="width: 68px;height: 100vh; display: flex; align-items: center; justify-content: center;">
            <h1 class="ok"  style="font-size: 10vw; font-weight: 800; text-align: center;padding: 5vw; color: green;">Internshala Server is Running <br> ! Thank you 🙏</h1>
        </div>`);
});
